...
using ShapeGraphics.External.ClipperLib;
...
namespace ShapeGraphics
{
    internal static class VectorClip
    {
        ...
        internal static void ClipGeometry(ShapeUtils.Geometry geom)
        {
        ...
        private static List<List<IntPoint>> BuildTriangleClipPaths(ShapeUtils.Geometry geom)
        {
        ...
        private static void BuildGeometryFromClipPaths(ShapeUtils.Geometry geom, List<List<IntPoint>> paths, List<Vector2> outVerts, List<UInt16> outInds, ref UInt16 maxIndex)
        {
