...
public class Triangulation
{
    ...
    public Triangulation(MeshCollider meshC)
    {
        ...
        this.lowerAngle = 1f;
        this.vertices = new List<Vertex>();
        for (i = 0; i < meshC.sharedMesh.vertices.Length; i++)
            this.vertices.Add(new Vertex(meshC.sharedMesh.vertices[i], 0, meshC.sharedMesh.normals[i], new Vector2() /*meshC.sharedMesh.uv[i]*/));
        this.triangles = new List<Polygon>();
